...
export default new class View {
  ...
  showStep3 () {
    ...
    btn.onclick = async () => {
      ...
      try {
        ...
        btn.disabled = false
        console.error(e)
        this.addLog(`Cant connect, please repeat...`)
    ...
    btn.onclick = async () => {
      ...
      table.insertAdjacentHTML(
        ...
        <tr>
          <td>${12}</td>
          <td>${23}</td>
          <td><div class="t" title="${1111}">${5555}</div></td>
          <td>${22}</td>
          <td>${444}</td>
          <td>${11111}</td>
        </tr>
  ...
  async disconnect () {
    ...
    try {
      ...
      console.error(e)
      this.addLog(`Disconnect result: error`)
    ...
    this.addLog(`Disconnect result: ${disconnect}`)
